...
description: >-
  ...
  Agent CLI running gpt-5.6-sol-high (GPT-5.6 Sol 1M High) via the
...
- The underlying model is **gpt-5.6-sol-high** (GPT-5.6 Sol 1M High) — the
  strongest reasoning model available among subagents.
